...
def create_tensor_of_val(dimensions, val):
    ...
    tensor([[3., 3., 3.], [3., 3., 3.]])
    """
    res = torch.ones(dimensions)*val  # function implemented
    return res
...
def calculate_matrix_product(X, W):
    ...
    """
    res = torch.matmul(X, W.T)  # function implemented 
    return res
...
def calculate_matrix_prod_with_bias(X, W, b):
    ...
    Hint: use torch.matmul to calculate the product.
          ...
          Also, it allows us to use the same function for a single neuron or multiple neurons.
       """
    res = torch.matmul(X, W.T)+b  # function implemented 
    return res
...
def calculate_activation(sum_total):
    ...
    """
    res = torch.heaviside(sum_total, torch.tensor(0.0)).float()  # function implemented 
    return res
...
def calculate_output(X, W, b):
    ...
    """
    res = calculate_activation(calculate_matrix_prod_with_bias(X, W, b))  # function implemented 
    return res
